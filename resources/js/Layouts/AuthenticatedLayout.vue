...
<template>
    <div class="min-h-screen bg-slate-100/50 dark:bg-slate-950 transition-colors duration-300 text-slate-900 dark:text-white">
        <!-- Notificación Toast -->
        <Transition
        ...
        >
            <div v-if="toast" class="fixed bottom-5 right-5 z-[100] max-w-sm w-full bg-white dark:bg-slate-800 shadow-2xl rounded-2xl border border-gray-100 dark:border-slate-700 p-4 flex items-center gap-3">
                <div class="bg-emerald-500/10 p-2 rounded-xl">
        ...
        <nav
            class="border-b border-gray-100 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md sticky top-0 z-50"
        >
                ...
                <div class="flex h-20 justify-between">
                    <div class="flex">
                        <div class="flex shrink-0 items-center">
                            ...
                            >
                                <div
                                    class="bg-emerald-500 p-3 rounded-2xl group-hover:scale-110 transition-all shadow-xl shadow-emerald-100 dark:shadow-none"
                                >
                                    <svg
                                ...
                                <span
                                    class="text-2xl font-black tracking-tighter text-slate-900 dark:text-white hidden md:block"
                                >
                                    Mi<span class="text-emerald-500"
                                        >Despensa</span
                                    >
                                </span>
                            </Link>
                    ...
                    <div class="hidden sm:ms-6 sm:flex sm:items-center gap-4">
                        ...
                        <button 
                            ...
                            class="p-2 rounded-xl bg-gray-50 dark:bg-slate-800 text-gray-500 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors"
                        >
                        ...
                        <div class="relative">
                            <Dropdown align="right" width="48" content-classes="py-1 bg-white dark:bg-slate-800 shadow-2xl">
                                <template #trigger>
                                    <span class="inline-flex rounded-2xl">
                                        <button
                                            type="button"
                                            class="inline-flex items-center rounded-2xl border-none bg-slate-100/50 dark:bg-slate-800/50 px-4 py-2.5 text-sm font-bold leading-4 text-slate-700 dark:text-slate-200 transition duration-150 ease-in-out hover:bg-slate-200/50 dark:hover:bg-slate-700 focus:outline-none focus:ring-0"
                                        >
                                ...
                                <template #content>
                                    <div class="p-1 dark:bg-slate-800">
                                        <DropdownLink
                    ...
                    <div class="-me-2 flex items-center sm:hidden gap-2">
                        ...
                        <button 
                            @click="toggleDarkMode"
                            class="p-2 rounded-lg text-gray-400 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors"
                        >
                        ...
                        <button
                            @click="
                                showingNavigationDropdown =
                                    !showingNavigationDropdown
                            "
                            class="inline-flex items-center justify-center rounded-lg p-2 text-gray-400 transition duration-150 ease-in-out hover:bg-emerald-50 dark:hover:bg-slate-800 hover:text-emerald-600 focus:outline-none"
                        >
                            <svg
                                class="h-6 w-6"
                                stroke="currentColor"
            ...
            <div
                ...
                class="sm:hidden bg-white dark:bg-slate-900 border-t border-gray-100 dark:border-slate-800"
            >
                ...
                <div class="border-t border-gray-100 dark:border-slate-800 pb-1 pt-4 bg-gray-50 dark:bg-slate-900/50">
        ...
        <header class="bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-800" v-if="$slots.header">
