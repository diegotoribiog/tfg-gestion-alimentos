    ...
    <section>
        ...
        <form @submit.prevent="updatePassword" class="mt-12 space-y-10">
            ...
            <div class="flex items-center gap-6 pt-4">
                <PrimaryButton :disabled="form.processing" class="rounded-2xl px-12 py-6 bg-emerald-500 font-black text-[11px] uppercase tracking-widest shadow-2xl dark:shadow-none transition-all hover:scale-105 active:scale-95">Actualizar Seguridad</PrimaryButton>
